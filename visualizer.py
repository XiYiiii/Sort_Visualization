...
class Visualizer:
    ...
    def _build_ui(self):
        ...
        self.speed_buttons = {
            "1x": pygame_gui.elements.UIButton(
                relative_rect=pygame.Rect((110, ui_height), (50, 30)),
                text="0.5x",
                manager=self.ui_manager,
            ),
            "5x": pygame_gui.elements.UIButton(
                relative_rect=pygame.Rect((170, ui_height), (50, 30)),
                text="1x",
                manager=self.ui_manager,
            ),
            "20x": pygame_gui.elements.UIButton(
                relative_rect=pygame.Rect((230, ui_height), (50, 30)),
                text="2x",
                manager=self.ui_manager,
            ),
            "100x": pygame_gui.elements.UIButton(
                relative_rect=pygame.Rect((290, ui_height), (50, 30)),
                text="4x",
                manager=self.ui_manager,
            ),
        }
        pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((360, ui_height), (70, 30)),
            text="Custom:",
            manager=self.ui_manager,
        )
        self.speed_input = pygame_gui.elements.UITextEntryLine(
            relative_rect=pygame.Rect((430, ui_height), (80, 30)),
            manager=self.ui_manager,
        )
    ...
    def draw_bars(self, data, sorted_indices):
        ...
        for i, val in enumerate(array):
            ...
            pygame.draw.rect(
                draw_surface, pygame.Color(color), (x_pos, y_pos, bar_width, bar_height)
            )
            pygame.draw.rect(
                draw_surface,
                pygame.Color(self.BACKGROUND_COLOR),
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if (
                    ...
                    and event.ui_element == self.speed_input
                ):
                    try:
            ...
            current_state = (
                history[history_index] if history else {"array": [], "highlights": {}}
            )
            if is_finished:
                final_array = history[-1]["array"]
                self.draw_bars(
                    {"array": final_array, "highlights": {}},
                    set(range(len(final_array))),
                )
            else:
